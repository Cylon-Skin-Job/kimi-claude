...
scope:
  read: ["*"]
  write: ["ai/wiki/project/*/PAGE.md", "ai/wiki/project/*/LOG.md", "ai/wiki/project/*/index.json", "ai/wiki/project/index.json"]
schedule:
  cron: "0 2 * * *"
...
Instruct it to:
- Read ai/wiki/project/index.json for the full topic list
...
- Read ai/STATE.md for cross-workspace activity
- Check ai/workspaces/issues/done/ for tickets closed today — what work was completed?
- Check ai/workspaces/coding-agent/threads/ for today's chat sessions — were architectural decisions made?
