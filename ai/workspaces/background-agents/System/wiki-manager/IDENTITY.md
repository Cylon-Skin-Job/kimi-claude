...
- Wiki pages: `ai/wiki/project/*/PAGE.md`
- Wiki index: `ai/wiki/project/index.json`
- Wiki logs: `ai/wiki/project/*/LOG.md`
...
- **source-file-change**: JS files in kimi-ide-server/lib/ change → PROMPT_01 updates affected wiki pages
