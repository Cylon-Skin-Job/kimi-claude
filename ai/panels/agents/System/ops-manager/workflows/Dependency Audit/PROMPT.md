...
scope:
  read: ["*"]
  write: ["kimi-ide-server/package.json", "kimi-ide-client/package.json"]
schedule:
  cron: "0 6 * * 1"
  ticket_title: "Weekly dependency audit"
  ticket_body: "Audit all dependencies in kimi-ide-server and kimi-ide-client for security vulnerabilities, outdated versions, and unused packages."
---
