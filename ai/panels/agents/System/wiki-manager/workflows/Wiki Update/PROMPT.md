...
Instruct it to:
- Read ai/wiki-data/project/index.json to identify which topics reference the changed file(s) via their `sources` arrays
...
- Update the topic's sources array in ai/wiki-data/project/index.json (list every file path this page now references)
