# Find dead functions in codebase

User

Do me a favor and read through my code and look for any dead functions.

Assistant

I'll scan through your codebase to find dead/unused functions. Let me start by exploring the project structure and then analyze the code.Let me read through the key source files to analyze for dead functions:Based on my analysis of your codebase, here are the **dead functions** I found—exported but never imported or used:
...
Please add a copy of this to my capture folder as a markdown file.

Assistant

Done! I've saved the dead functions analysis to `ai/panels/capture/dead-functions-analysis.md`.
